...
const PlayerPage = () => {
  ...
  {tracks.map((track, index) => (
    <div key={index} className="flex flex-col items-center flex-grow">
      <audio ref={audioRefs.current[index]} src={track} data-index={index} />
      <input
        type="range"
        min="0"
        max="1"
        ...
        className="range-sub-input transform -rotate-90 w-24 h-6" // Adjust width and height for vertical range
