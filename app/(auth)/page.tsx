  ...
  return (
    <div className='px-6 mt-8'>
        ...
        <div className="space-y-4 mb-16">
          <Link href="/home/create" className="cursor-pointer block w-full bg-white text-2xl text-[#0A0A0B] py-3.5 rounded-full font-bold hover:bg-opacity-85 transition duration-300">
            Try for free
          </Link>
